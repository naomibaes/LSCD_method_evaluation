...
input_base_dir = "output/all-year/control"
output_base_dir = input_base_dir + "/collocates"

# Process the files in both 'high' and 'low' subdirectories
for intensity in ["high", "low"]:
    input_dir = os.path.join(input_base_dir, intensity)

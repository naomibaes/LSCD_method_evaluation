...
# Load the data
df = pd.read_csv("output/control_averaged_arousal_index_all-year_normalized.csv")
...
for term in target_terms:
    ...
    if not term_data.empty:
        ...
        ax1.errorbar(sorted_data['round_number'], sorted_data['avg_arousal_index_high'],
        ...
        ax2.errorbar(sorted_data['round_number'], sorted_data['avg_arousal_index_low'],
...
ax1.text(0.03, 0.95, 'High Intensity Injection', transform=ax1.transAxes, fontsize=18, verticalalignment='top')
ax2.text(0.03, 0.95, 'Low Intensity Injection', transform=ax2.transAxes, fontsize=18, verticalalignment='top')
...
ax1.set_ylabel('Arousal Index (±SE)', fontsize=14)
ax2.set_ylabel('Arousal Index (±SE)', fontsize=14)
...
#plt.savefig("Arousal_index_plot.png", dpi=300, bbox_inches='tight')
plt.show()

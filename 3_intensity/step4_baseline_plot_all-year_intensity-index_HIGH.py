...
offsets = {term: i * 1.6 for i, term in enumerate(target_terms)}  # Adjust 0.08 as needed to reduce or increase spacing
...
for term in target_terms:
    ...
    if not term_data.empty:
        ...
        ax.errorbar(adjusted_ratios, term_data['avg_arousal_index_high'],
...
ax.set_xlabel('High Synthetic Sentence Injections (%)', fontsize=16)
ax.set_ylabel('Arousal Index (±SE)', fontsize=16)
...
plt.tight_layout()
plt.savefig("../figures/plot_all-year_intensity_HIGH_baseline.png", dpi=300, bbox_inches='tight')
plt.show()

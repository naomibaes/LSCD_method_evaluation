...
for term in target_terms:
    ...
    if not term_data.empty:
        ...
        ax.errorbar(adjusted_ratios, term_data['avg_arousal_index_low'],
...
ax.set_xlabel('Low Synthetic Sentence Injections (%)', fontsize=16)
...
plt.tight_layout()
plt.savefig("../figures/plot_all-year_intensity_LOW_baseline.png", dpi=300, bbox_inches='tight')
plt.show()

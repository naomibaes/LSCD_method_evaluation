...
base_output_dir = 'output/5-year/control/input'
        ...
        for epoch in epochs:
            ...
            if not master_df.empty:
                ...
                if master_df.shape[1] >= 3:
                    ...
                    natural_output_path = os.path.join(natural_output_dir, f"{target}_{epoch}_5-year_intensity_natural.tsv")
                    synthetic_output_path = os.path.join(synthetic_output_dir, f"{target}_{epoch}_5-year_intensity_synthetic.tsv")

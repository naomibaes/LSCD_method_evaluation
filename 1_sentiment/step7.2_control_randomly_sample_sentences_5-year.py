...
def process_target_and_interval(args):
    ...
    natural_file_path = os.path.join(base_input_dir, condition, "natural", f"{target}_{start}-{end}_5-year_sentiment_natural.tsv")
    ...
    synthetic_file_path = os.path.join(base_input_dir, condition, "synthetic", f"{target}_{start}-{end}_5-year_sentiment_synthetic.tsv")

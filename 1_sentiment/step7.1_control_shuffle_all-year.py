    ...
    for condition, folder in conditions.items():
        ...
        if not master_df.empty:
            ...
            if master_df.shape[1] >= 2:
                ...
                natural_output_path = os.path.join(natural_output_dir, f"{target}_all-year_sentiment_natural.tsv")
                synthetic_output_path = os.path.join(synthetic_output_dir, f"{target}_all-year_sentiment_synthetic.tsv")

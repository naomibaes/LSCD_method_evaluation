...
class File:
    ...
    def sentences(self) -> List[str]:
        # file is a csv, first column is the sentence
...
def get_inputs_to_embeddings(data_folder, model, pickle_filename = 'inputs_to_embeddings_all-year.pkl'):
...
output_folder = "output/all-year.cosine"

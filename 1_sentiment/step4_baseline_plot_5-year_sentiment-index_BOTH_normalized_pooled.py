...
try:
    df = pd.read_csv("output/baseline_averaged_valence_index_5-year_normalized_pooled.csv")
...
plt.savefig("../figures/plot_5-year_sentiment_BOTH_baseline_normalized_pooled.png", dpi=600, bbox_inches='tight')
plt.show()

...
# Error processing filename abuse_1970-1974_synthetic_sentiment_0.3_lemmatized_collocates.csv: Injection ratio not found or invalid format.
...
def process_collocates(input_dir, output_dir, warriner_ratings):
    ...
    if results:
        ...
        pivot_df.to_csv(os.path.join(output_dir, 'baseline_averaged_valence_index_5-year_normalized.csv'), index=False)
    else:

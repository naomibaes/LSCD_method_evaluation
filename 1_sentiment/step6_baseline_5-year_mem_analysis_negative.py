...
full_model = smf.mixedlm("avg_valence_index_negative ~ injection_ratio", data, groups=data['target'], re_formula="1").fit()
print("Full Model Summary:")
print(full_model.summary())

# Model comparison with and without 'epoch'
model_with_epoch = smf.mixedlm("avg_valence_index_negative ~ injection_ratio * epoch", data, groups=data['target'], re_formula="1").fit()
...
ols_model = smf.ols("avg_valence_index_negative ~ injection_ratio", data=data).fit()

...
# Load the data
df = pd.read_csv("output/baseline_averaged_valence_index_all-year_normalized.csv")
...
plt.savefig("../figures/plot_all-year_sentiment_BOTH_baseline_with_SE_normalized.png", dpi=600, bbox_inches='tight')
plt.show()
